  ...
  <div class="weekly-best">
    ...
    <div class="best-content">
      ...
      <div class="best-photo first">
        ...
        <div
          class="photo-image"
          :class="{ 'empty-image': !bestPhotos[0].imageUrl }"
        >
          <img
            v-if="bestPhotos[0].imageUrl"
            :src="bestPhotos[0].imageUrl"
            :alt="bestPhotos[0].alt"
          />
        </div>
          ...
          <div class="photo-header">
            <div class="user-info">
              <div class="user-avatar">
                <img
                  :src="bestPhotos[0].userAvatar"
                  :alt="bestPhotos[0].userName"
                />
              </div>
              <div>
            ...
            <div class="like-button" @click="likePhoto(0)">
              ...
              >
                <path
                  :d="bestPhotos[0].isLiked ? heartFilled : heartOutline"
                  fill="currentColor"
                />
              </svg>
      ...
      <div class="runners-up">
        <div
          v-for="(photo, index) in bestPhotos.slice(1, 3)"
          :key="index + 1"
          :class="`best-photo ${index === 0 ? 'second' : 'third'}`"
        >
          ...
          <div class="photo-info">
            <div class="photo-header">
              ...
              <div class="like-count">
                ...
                >
                  <path
                    :d="photo.isLiked ? heartFilled : heartOutline"
                    fill="currentColor"
                  />
                </svg>
                {{ photo.likes }}
...
export default {
  ...
  data() {
    return {
      ...
      heartFilled:
        "M16.5 3C14.76 3 13.09 3.81 12 5.09C10.91 3.81 9.24 3 7.5 3C4.42 3 2 5.42 2 8.5C2 12.28 5.4 15.36 10.55 20.04L12 21.35L13.45 20.03C18.6 15.36 22 12.28 22 8.5C22 5.42 19.58 3 16.5 3Z",
      heartOutline:
      ...
      bestPhotos: [
        {
          ...
          comments: 35,
          description:
            "석양이 비치는 향원정의 아름다운 풍경을 담았습니다. 가을의 정취가 가득한 순간이었어요!",
        },
        {
          id: 2,
  ...
  methods: {
    changePeriod(direction) {
      ...
      const month = 10;
      const week =
        parseInt(this.currentPeriod.match(/(\d+)주차/)[1]) + direction;
