<template>
  <div class="mission-detail">
    ...
    <div class="mission-header">
      ...
      <h2>{{ mission.title }}</h2>
      <div class="mission-location">{{ mission.location }} · {{ mission.address }}</div>
    </div>
    ...
    <div class="mission-content">
      ...
      <div class="upload-section">
        <h4>사진 업로드</h4>
        <p>미션에 맞는 사진을 업로드하세요. 높은 점수를 받으면 주간 베스트 사진으로 선정될 수 있습니다!</p>
  ...
  data() {
    return {
      mission: {
        ...
        address: '서울 종로구',
        points: 200,
        description: '경복궁에서 가장 아름다운 영역 중 하나인 동궁과 후원의 풍경을 담아보세요. 조선시대 왕세자가 거처했던 이곳은 연못과 정자가 조화롭게 어우러져 있습니다.',
        tips: [
