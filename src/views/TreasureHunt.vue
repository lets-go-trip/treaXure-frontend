      ...
      <div class="info-card" v-if="selectedLocation">
        <div class="info-header">
          <div class="location-icon">
            ...
            >
              <path
                d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16 16H8V14H16V16ZM16 13H8V11H16V13ZM16 10H8V8H16V10Z"
                fill="currentColor"
                class="icon-fill"
              />
            </svg>
        ...
        <div class="info-stats">
          <div class="stat-value-parent">
            퀘스트
            <span class="stat-value">{{ selectedLocation.questCount }}개</span>
          </div>
          <div class="stat-value-parent">
            보상 <span class="stat-value">{{ selectedLocation.coins }}</span>
          </div>
          <div class="stat-value-parent">
            상태 <span class="stat-value">{{ selectedLocation.status }}</span>
          </div>
        </div>
